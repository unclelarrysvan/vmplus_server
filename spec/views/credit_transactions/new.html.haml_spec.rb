...
describe "credit_transactions/new" do
  before(:each) do
    assign(:credit_transaction, stub_model(CreditTransaction,
  ...
  it "renders new credit_transaction form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => credit_transactions_path, :method => "post" do
